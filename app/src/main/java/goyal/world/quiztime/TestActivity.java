...
import goyal.world.quiztime.Adapters.TestAdapter;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(DbQuery.g_catList.get(DbQuery.g_selected_cat_index).getName()); // for selected category
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            TestActivity.this.finish();// kill this activity
        }
